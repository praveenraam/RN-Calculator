  ...
  return (
    <View className="grid grid-rows-4 grid-flow-row gap-4">
        ...
        <View className="flex flex-row justify-center items-center mx-auto">
            <Pressable className="m-1.5 mx-7 w-20 h-20 bg-red-400 rounded-full flex items-center justify-center">
                <Text className="text-center text-white">Reset</Text>
            </Pressable>
            <Pressable className="m-1.5 mx-7 w-20 h-20 bg-gray-700 rounded-full flex items-center justify-center">
        ...
        <View className="flex flex-row justify-center items-center mx-auto">
                {['1','2','3'].map((char) => (
                    <Pressable key={char} className="m-1.5 mx-7 w-20 h-20 bg-gray-700 rounded-full flex items-center justify-center">
